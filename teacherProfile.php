                ...
                <div class="col-12 col-md-6 text-md-end text-center mt-3 mt-md-0">
                    <div class="d-flex flex-wrap justify-content-center justify-content-md-end gap-2">
                        <a class="btn btn-danger mb-2"
                            href="assets/pdf/คู่มือการจัดการทีมของครูที่เข้าร่วมโครงการ.pdf" target="_blank">คู่มือกาารจัดการทีม
                        </a>
                        <a class="btn btn-warning mb-2"
                            href="forms/teacher_edit.php?teacher_id=<?php echo $result["teacher_id"]; ?>">แก้ไขข้อมูลส่วนตัว
                        </a>
                    </div>
                </div>
            </div>
        ...
        <div class="container text-center mt-5">
            <div class="row flex-column flex-md-row">
                ...
                <div class="col text-start">
                    ...
                    <p>วิชาที่สอน: <?php echo htmlspecialchars($result["subject"]); ?></p>
                    ...
                    <div class="mt-3" style="display: flex; align-items: center; gap: 10px;">
                        <?php if ($result["status"] === "false" || $result["status"] === 0): ?>
                            <a href="forms/create_team.php?teacher_id=<?php echo $result["teacher_id"]; ?>"
                                class="btn btn-primary">จัดการทีม</a>
                        <?php else: ?>
                            <a href="forms/create_team.php?teacher_id=<?php echo $result["teacher_id"]; ?>"
                                class="btn btn-primary">จัดการทีม</a>
                            <a href="forms/manage_team copy.php?teacher_id=<?php echo $result["teacher_id"]; ?>"
